({
    ...
    onSelection: function (component, event, helper) {
        ...
        action.setCallback(this, function (response) {
            ...
            if (component.isValid() && state === "SUCCESS") {
                ...
                if (Object.keys(response.flowNames).length > 0 && response.records.length > 0) {
                    ...
                    var flows = [];
                    var flowMap = response.flowNames;

                    //Prop for an object - Key for a map
                    for (var prop in flowMap) {
                        flows.push({ value: flowMap[prop], prop: prop });
                    }
    ...
    handleNameFilterChange: function (component, event, helper) {
        ...
        //Workaround to restart the component when cliking on the delete icon
